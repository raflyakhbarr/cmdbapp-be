...
const serviceToServiceConnectionRoutes = require('./routes/serviceToServiceConnectionRoutes');
...
app.use('/api/service-to-service-connections', serviceToServiceConnectionRoutes);
