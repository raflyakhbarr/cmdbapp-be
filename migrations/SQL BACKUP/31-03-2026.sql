...
\restrict Ec3X6RFyZfFcWBFmM78ETqXFbSylxGW614fNioNqrTTuXX3GslZ5YIW37ZfcxZQ
...
\unrestrict Ec3X6RFyZfFcWBFmM78ETqXFbSylxGW614fNioNqrTTuXX3GslZ5YIW37ZfcxZQ
\connect cmdb_db
\restrict Ec3X6RFyZfFcWBFmM78ETqXFbSylxGW614fNioNqrTTuXX3GslZ5YIW37ZfcxZQ
...
INSERT INTO public.cmdb_groups (id, name, description, color, "position", created_at, workspace_id) VALUES (80, 'Production', 'Production servers', '#10b981', '{"x": -105.4859199257005, "y": -377.03953069321165}', '2026-03-30 08:39:14.745865', 29) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_groups (id, name, description, color, "position", created_at, workspace_id) VALUES (81, 'DM', '', '#e0e7ff', '{"x": -1068.610390884252, "y": -897.6500605289864}', '2026-03-31 08:42:26.159708', 29) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (393, 'TPSAPP05', 'server', '', '{"x": 669.4976366319949, "y": -3877.747049760618}', 'active', '172.19.155.51', 'internal', '', NULL, 0, 'fisik', 27, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (397, 'TPSGATE', 'server', '', '{"x": 950.802791059928, "y": -3595.2717627644793}', 'active', '', 'internal', '', NULL, 0, 'fisik', 27, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (395, 'TPSHSSE', 'server', '', '{"x": 675.601159670015, "y": -3476.4088482589486}', 'active', '172.19.154.42', 'internal', '', NULL, 0, 'fisik', 27, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (394, 'TPSDEV', 'server', '', '{"x": 675.2858002802376, "y": -3623.173788335632}', 'active', '172.19.154.95', 'internal', '', NULL, 0, 'fisik', 27, NULL, 'my.tps.co.id', 8333) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (480, 'SWITCH IMP TEST3', 'switch', NULL, '{"x": -410.5647968931357, "y": -341.8051585785086}', 'active', NULL, NULL, NULL, 81, 3, NULL, 29, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (460, 'SWITH IMP TEST1', 'switch', NULL, '{"x": -32.28927359014449, "y": 425.48371749034806}', 'active', NULL, NULL, NULL, 82, 1, NULL, 29, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (392, 'TPSAPP02', 'database', '', '{"x": 915.672483864968, "y": -3878.1053205016487}', 'active', '172.19.155.50', 'internal', '', NULL, 0, 'fisik', 27, NULL, NULL, 5432) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (401, 'TGI4', 'server', '', '{"x": -371.46621375607464, "y": -582.5691974891718}', 'active', '', 'internal', '', 74, 1, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (402, 'TGI5', 'server', '', '{"x": 37.79777219793064, "y": -361.64775121154366}', 'active', '', 'internal', '', 74, 4, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (400, 'TGI3', 'server', '', '{"x": 59.22141385184452, "y": -693.6083650573937}', 'active', '', 'internal', '', 74, 5, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (398, 'TGI1', 'server', '', '{"x": -236.1768174037234, "y": -527.638870815729}', 'active', '', 'internal', '', 74, 3, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (403, 'SS', 'server', '', '{"x": 2.1917635341948767, "y": -607.743364833769}', 'active', '', 'internal', '', 74, 2, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (404, 'WSTI0', 'server', '', '{"x": -41.85453909171808, "y": -926.0911142875269}', 'active', '', 'internal', '', 74, 6, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (454, 'SERVER IMP TEST2', 'server', NULL, '{"x": -663.1209007095686, "y": -155.8469217542872}', 'active', NULL, NULL, NULL, 81, 0, NULL, 29, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (449, 'DB IMP TEST2', 'database', NULL, '{"x": -669.0402594947933, "y": 229.93623109022832}', 'active', NULL, NULL, NULL, 81, 1, NULL, 29, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (451, 'DB IMP TEST4', 'database', NULL, '{"x": -659.5461183400998, "y": 14.834595554208278}', 'active', NULL, NULL, NULL, 82, 2, NULL, 29, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (470, 'SWITCH IMP TEST2', 'switch', NULL, '{"x": -64.72832686763456, "y": 377.7780531729221}', 'active', NULL, NULL, NULL, 82, 0, NULL, 29, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction) VALUES (283, 451, 449, '2026-03-31 09:24:53.909518', NULL, NULL, 29, 'depends_on', 'forward') ON CONFLICT DO NOTHING;
...
INSERT INTO public.cross_service_edge_handles (id, edge_id, source_service_id, target_service_id, source_handle, target_handle, workspace_id, created_at, updated_at) VALUES (1, 'cross-service-33-44', 31, 32, 'source-bottom', 'target-left', 27, '2026-03-13 19:43:21.103877', '2026-03-13 19:47:15.25708') ON CONFLICT DO NOTHING;
INSERT INTO public.cross_service_edge_handles (id, edge_id, source_service_id, target_service_id, source_handle, target_handle, workspace_id, created_at, updated_at) VALUES (4, 'cross-service-55-56', 38, 39, 'source-top', 'target-left', 5, '2026-03-13 22:34:03.881976', '2026-03-13 22:34:03.881976') ON CONFLICT DO NOTHING;
INSERT INTO public.cross_service_edge_handles (id, edge_id, source_service_id, target_service_id, source_handle, target_handle, workspace_id, created_at, updated_at) VALUES (8, 'cross-service-67-61', 40, 41, 'source-bottom', 'target-left', 28, '2026-03-25 08:40:05.7734', '2026-03-25 11:10:21.163213') ON CONFLICT DO NOTHING;
INSERT INTO public.cross_service_edge_handles (id, edge_id, source_service_id, target_service_id, source_handle, target_handle, workspace_id, created_at, updated_at) VALUES (5, 'cross-service-58-61', 40, 41, 'source-bottom', 'target-right', 28, '2026-03-17 10:21:35.13117', '2026-03-25 11:10:23.86978') ON CONFLICT DO NOTHING;
...
INSERT INTO public.external_item_positions (id, workspace_id, service_id, external_service_item_id, "position", updated_at, created_at) VALUES (1, 27, 31, 44, '{"x": 5.151097128431161, "y": 352.793190305936}', '2026-03-13 21:28:01.241486', '2026-03-13 09:51:48.260847') ON CONFLICT DO NOTHING;
INSERT INTO public.external_item_positions (id, workspace_id, service_id, external_service_item_id, "position", updated_at, created_at) VALUES (18, 5, 38, 56, '{"x": -205.59398995234642, "y": -300.1491735587452}', '2026-03-13 22:33:21.557592', '2026-03-13 22:33:21.557592') ON CONFLICT DO NOTHING;
INSERT INTO public.external_item_positions (id, workspace_id, service_id, external_service_item_id, "position", updated_at, created_at) VALUES (19, 5, 39, 53, '{"x": 95.3232224594575, "y": -156.66115681697488}', '2026-03-13 22:34:30.152282', '2026-03-13 22:34:28.350645') ON CONFLICT DO NOTHING;
INSERT INTO public.external_item_positions (id, workspace_id, service_id, external_service_item_id, "position", updated_at, created_at) VALUES (21, 5, 39, 55, '{"x": -120.48684104417293, "y": 78.17473125505632}', '2026-03-13 22:34:31.615428', '2026-03-13 22:34:31.615428') ON CONFLICT DO NOTHING;
INSERT INTO public.external_item_positions (id, workspace_id, service_id, external_service_item_id, "position", updated_at, created_at) VALUES (8, 27, 32, 33, '{"x": -436.48967785348617, "y": 142.27532709131037}', '2026-03-14 04:45:35.152232', '2026-03-13 19:43:41.649738') ON CONFLICT DO NOTHING;
INSERT INTO public.external_item_positions (id, workspace_id, service_id, external_service_item_id, "position", updated_at, created_at) VALUES (42, 28, 41, 67, '{"x": 26.008607087020664, "y": -84.39870154779442}', '2026-03-25 08:39:58.843612', '2026-03-25 08:39:58.843612') ON CONFLICT DO NOTHING;
INSERT INTO public.external_item_positions (id, workspace_id, service_id, external_service_item_id, "position", updated_at, created_at) VALUES (43, 28, 41, 58, '{"x": 525.8296493887353, "y": -133.44144009349463}', '2026-03-25 08:40:38.582792', '2026-03-25 08:40:38.582792') ON CONFLICT DO NOTHING;
INSERT INTO public.external_item_positions (id, workspace_id, service_id, external_service_item_id, "position", updated_at, created_at) VALUES (24, 28, 40, 61, '{"x": 50.04754354579245, "y": 163.73639215876108}', '2026-03-25 11:15:54.593358', '2026-03-17 09:18:56.544488') ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_groups (id, service_id, name, description, color, "position", created_at, workspace_id) VALUES (12, 42, '44', '', '#e0e7ff', '{"x": 96.44253755279965, "y": 50.14239271394001}', '2026-03-31 09:15:58.667688', 29) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (50, 36, 'Alesys', 'server', '', '{"x": 55.84568556280569, "y": 266.00251254732075}', 'active', '172.19.154.42', 'internal', '', 27, '2026-03-12 13:42:08.167155', '2026-03-12 13:42:54.169911', NULL, NULL, 'alesys.tps.co.id', 8111) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (52, 37, 'My TPS Vendor Admin', 'server', '', '{"x": 202.4268229789211, "y": 118.67580316694651}', 'active', '172.19.154.42', 'internal', '', 27, '2026-03-12 13:43:55.696981', '2026-03-12 13:44:00.317769', NULL, NULL, 'vss.tps.co.id', 32005) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (41, 33, 'QR Portal', 'server', '', '{"x": 353.649024377824, "y": 41.06528142872418}', 'active', '172.19.155.51', 'internal', '', 27, '2026-03-12 08:25:12.669772', '2026-03-12 14:38:55.723961', NULL, NULL, 'portal.tps.co.id', 84) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (40, 33, 'Working Permit', 'server', '', '{"x": 162.75539214785888, "y": 41.49407857663502}', 'active', '172.19.155.51', 'internal', '', 27, '2026-03-12 08:24:38.329731', '2026-03-12 14:38:55.731664', NULL, NULL, 'gss.tps.co.id', 82) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (42, 33, 'Meeting Room Pengguna', 'server', '', '{"x": 543.0683846987198, "y": 41.18553690419236}', 'active', '172.19.155.51', 'internal', '', 27, '2026-03-12 08:25:56.614733', '2026-03-12 14:38:55.739954', NULL, NULL, 'room.tps.co.id', 8589) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (33, 31, 'Kantin Database', 'database', '', '{"x": -436.48967785348617, "y": 142.27532709131037}', 'inactive', '172.19.155.50', 'internal', '', 27, '2026-03-11 13:38:34.094558', '2026-03-30 14:26:50.08452', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (44, 32, 'Kantin', 'server', '', '{"x": 5.151097128431161, "y": 352.793190305936}', 'active', '172.19.155.51', 'internal', '', 27, '2026-03-12 08:27:48.961374', '2026-03-27 13:33:00.941824', NULL, NULL, 'canteen.tps.co.id', 83) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (65, 40, '8', 'server', '', '{"x": 15, "y": 275}', 'active', '', 'internal', '', 28, '2026-03-17 13:55:44.04359', '2026-03-25 11:09:49.917431', 10, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (32, 31, 'Elektra Database', 'database', '', '{"x": 16.202150597355512, "y": 10.077719867357985}', 'active', '172.19.155.50', 'internal', '', 27, '2026-03-11 13:38:24.655086', '2026-03-27 13:33:07.577545', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (51, 36, 'Elektra', 'server', '', '{"x": 238.58935815088654, "y": 265.7909251505937}', 'active', '172.19.154.42', 'internal', '', 27, '2026-03-12 13:42:43.910871', '2026-03-27 13:33:36.403121', NULL, NULL, 'elektra.tps.co.id', 8111) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (61, 41, 'SS1 Service', 'server', '', '{"x": 50.04754354579245, "y": 163.73639215876108}', 'active', '', 'external', '', 28, '2026-03-17 09:18:23.487013', '2026-03-30 14:23:37.140501', NULL, 3, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (34, 31, 'Gateway Database', 'database', '', '{"x": -441.1569842608683, "y": 12.033374139293073}', 'active', '172.19.155.50', 'internal', '', 27, '2026-03-11 13:38:55.261448', '2026-03-17 10:03:10.459032', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (35, 31, 'Gateway Database Dev', 'database', '', '{"x": -227.01856656010023, "y": 12.008285479064284}', 'active', '172.19.155.50', 'internal', '', 27, '2026-03-11 13:39:13.494432', '2026-03-17 10:03:15.266702', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (68, 41, 'SS1It', 'server', '', '{"x": 192.60726592940222, "y": 354.4797240403574}', 'active', '', 'internal', '', 28, '2026-03-17 14:03:18.95216', '2026-03-25 08:40:18.795859', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (58, 40, 'TSGI2', 'web_application', '', '{"x": 422.8998886978436, "y": 249.00783151659385}', 'inactive', '', 'internal', '', 28, '2026-03-16 14:34:28.456735', '2026-03-25 11:09:58.635009', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (67, 40, '10', 'server', '', '{"x": -247.69379012060392, "y": -23.03744338416155}', 'inactive', '', 'internal', '', 28, '2026-03-17 13:55:51.335482', '2026-03-30 14:23:42.488173', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (33, 393, '.NET', 'active', 'upload', '/uploads/cmdb-1773214861167-570179837.png', NULL, NULL, '2026-03-11 14:41:00.77037', '2026-03-12 13:35:39.722611') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (36, 395, 'NextJS', 'active', 'upload', '/uploads/cmdb-1773297614669-9992140.webp', NULL, NULL, '2026-03-12 13:40:14.610132', '2026-03-12 13:40:51.792654') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (37, 395, '.NET', 'active', 'upload', '/uploads/cmdb-1773297652077-255781684.png', NULL, NULL, '2026-03-12 13:40:52.010662', '2026-03-12 13:40:52.090414') ON CONFLICT DO NOTHING;
...
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (41, 403, 'SS1', 'active', 'preset', NULL, 'citrix', NULL, '2026-03-17 09:18:11.907902', '2026-03-17 10:59:14.120736') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (31, 392, 'PostgreSQL', 'active', 'upload', '/uploads/cmdb-1773211071627-590990177.webp', NULL, NULL, '2026-03-11 13:37:51.602131', '2026-03-17 13:50:06.979795') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (40, 401, 'Citrix', 'active', 'preset', NULL, 'citrix', NULL, '2026-03-16 14:33:18.440082', '2026-03-17 14:00:05.438575') ON CONFLICT DO NOTHING;
...
INSERT INTO public.share_access_logs (id, share_link_id, visitor_ip, visitor_user_agent, accessed_at) VALUES (134, 19, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36', '2026-03-12 11:10:50.396985') ON CONFLICT DO NOTHING;
INSERT INTO public.share_access_logs (id, share_link_id, visitor_ip, visitor_user_agent, accessed_at) VALUES (135, 19, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36', '2026-03-12 11:10:50.51758') ON CONFLICT DO NOTHING;
...
INSERT INTO public.share_links (id, token, workspace_id, created_by, created_at, expires_at, is_active, access_count, password_hash, last_accessed_at, metadata) VALUES (19, '3D387X8C', 27, 1889, '2026-03-12 11:10:46.489906', '2026-03-12 12:10:46.488', true, 2, NULL, '2026-03-12 11:10:50.51758', '{}') ON CONFLICT DO NOTHING;
...
SELECT pg_catalog.setval('public.cmdb_groups_id_seq', 82, true);
...
SELECT pg_catalog.setval('public.cmdb_items_id_seq', 457, true);
...
SELECT pg_catalog.setval('public.connections_id_seq', 283, true);
...
SELECT pg_catalog.setval('public.cross_service_connections_id_seq', 18, true);
...
SELECT pg_catalog.setval('public.cross_service_edge_handles_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.edge_handles_id_seq', 223, true);
...
SELECT pg_catalog.setval('public.external_item_positions_id_seq', 45, true);
...
SELECT pg_catalog.setval('public.service_items_id_seq', 71, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 42, true);
...
SELECT pg_catalog.setval('public.share_access_logs_id_seq', 135, true);
...
SELECT pg_catalog.setval('public.share_links_id_seq', 19, true);
...
ALTER TABLE ONLY public.cross_service_edge_handles
    ADD CONSTRAINT cross_edge_unique UNIQUE (edge_id, source_service_id, target_service_id);
