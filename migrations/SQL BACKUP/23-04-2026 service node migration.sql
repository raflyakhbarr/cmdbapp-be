...
\restrict fenrgHbedFbHk1ZeRKGDI86fBHVCIDsAJeXQJGEtpFsWQdovSiSqqaBK7ZyWDmA
...
\unrestrict fenrgHbedFbHk1ZeRKGDI86fBHVCIDsAJeXQJGEtpFsWQdovSiSqqaBK7ZyWDmA
\connect cmdb_db
\restrict fenrgHbedFbHk1ZeRKGDI86fBHVCIDsAJeXQJGEtpFsWQdovSiSqqaBK7ZyWDmA
...
INSERT INTO public.cmdb_groups (id, name, description, color, "position", created_at, workspace_id) VALUES (74, 'TG1', '', '#e0e7ff', '{"x": -1576.321082046154, "y": -2522.10365422045}', '2026-03-16 14:07:42.244738', 28) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (402, 'TGI5', 'server', '', '{"x": -345.2812439143111, "y": -2571.6470162262053}', 'active', '', 'internal', '', NULL, NULL, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (403, 'SS', 'server', '', '{"x": -913.5411834688053, "y": -2517.7814698582915}', 'active', '', 'internal', '', NULL, NULL, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (401, 'TGI4', 'server', '', '{"x": 256.6996635334114, "y": -1703.594288430948}', 'active', '', 'internal', '', NULL, NULL, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.layanan (id, name, description, status, "position", workspace_id, created_at, updated_at) VALUES (5, 'Layanan Test 1', NULL, 'active', '{"x": -421.1284384691269, "y": -2249.625063565137}', 28, '2026-04-21 14:42:51.77607', '2026-04-23 16:29:40.894723') ON CONFLICT DO NOTHING;
...
INSERT INTO public.layanan_connections (id, source_type, source_id, target_type, target_id, workspace_id, connection_type, created_at, updated_at) VALUES (36, 'service', 59, 'layanan', 5, 28, 'connects_to', '2026-04-23 16:29:20.088115', '2026-04-23 16:29:20.088115') ON CONFLICT DO NOTHING;
...
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at, workspace_id, "position", width, height, is_expanded) VALUES (56, 402, 'TGIS1', 'active', 'preset', NULL, 'citrix', NULL, '2026-04-23 10:10:23.484302', '2026-04-23 10:49:01.066558', 28, '{"x": 0, "y": 0}', 120, 80, false) ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at, workspace_id, "position", width, height, is_expanded) VALUES (58, 403, 'SS2', 'active', 'preset', NULL, 'citrix', NULL, '2026-04-23 10:58:39.988953', '2026-04-23 10:58:58.588941', 28, '{"x": 0, "y": 0}', 120, 80, false) ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at, workspace_id, "position", width, height, is_expanded) VALUES (59, 403, 'SS3', 'active', 'preset', NULL, 'citrix', NULL, '2026-04-23 10:58:48.467312', '2026-04-23 10:58:58.660273', 28, '{"x": 0, "y": 0}', 120, 80, false) ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at, workspace_id, "position", width, height, is_expanded) VALUES (60, 403, 'SS4', 'active', 'preset', NULL, 'citrix', NULL, '2026-04-23 10:58:58.957537', '2026-04-23 10:58:58.957537', 28, '{"x": 0, "y": 0}', 120, 80, false) ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at, workspace_id, "position", width, height, is_expanded) VALUES (57, 403, 'SS1', 'inactive', 'preset', NULL, 'citrix', NULL, '2026-04-23 10:38:01.282726', '2026-04-23 16:57:05.403532', 28, '{"x": 0, "y": 0}', 120, 80, false) ON CONFLICT DO NOTHING;
...
SELECT pg_catalog.setval('public.connections_id_seq', 295, true);
...
SELECT pg_catalog.setval('public.edge_handles_id_seq', 253, true);
...
SELECT pg_catalog.setval('public.layanan_connections_id_seq', 36, true);
...
SELECT pg_catalog.setval('public.service_items_id_seq', 86, true);
...
SELECT pg_catalog.setval('public.service_to_service_connections_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 60, true);
