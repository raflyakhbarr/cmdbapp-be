...
\restrict lifPnBaAA5O54EpHBj3U5835KLoDQwF2GcfFPfVlazC54dbymdtoeqP4tbazU2d
...
\unrestrict lifPnBaAA5O54EpHBj3U5835KLoDQwF2GcfFPfVlazC54dbymdtoeqP4tbazU2d
\connect cmdb_db
\restrict lifPnBaAA5O54EpHBj3U5835KLoDQwF2GcfFPfVlazC54dbymdtoeqP4tbazU2d
...
--
-- Name: layanan_connections; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.layanan_connections (
    id integer NOT NULL,
    ...
    workspace_id integer NOT NULL,
    connection_type character varying(50) DEFAULT 'connects_to'::character varying,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Name: layanan_connections_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.layanan_connections_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: layanan_connections_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.layanan_connections_id_seq OWNED BY public.layanan_connections.id;
...
--
-- Name: layanan_service_connections; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.layanan_service_connections (
    id integer NOT NULL,
    layanan_id integer NOT NULL,
    service_id integer NOT NULL,
    service_item_id integer NOT NULL,
    workspace_id integer NOT NULL,
    connection_type character varying(50) DEFAULT 'depends_on'::character varying,
...
--
-- Name: layanan_service_connections_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.layanan_service_connections_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: layanan_service_connections_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.layanan_service_connections_id_seq OWNED BY public.layanan_service_connections.id;
...
CREATE TABLE public.service_to_service_connections (
    ...
    CONSTRAINT valid_service_direction CHECK (((direction)::text = ANY ((ARRAY['forward'::character varying, 'backward'::character varying, 'bidirectional'::character varying])::text[]))),
    CONSTRAINT valid_service_propagation CHECK (((propagation)::text = ANY ((ARRAY['source_to_target'::character varying, 'target_to_source'::character varying, 'both'::character varying])::text[])))
);
...
--
-- Name: layanan_connections id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layanan_connections ALTER COLUMN id SET DEFAULT nextval('public.layanan_connections_id_seq'::regclass);


--
-- Name: layanan_service_connections id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layanan_service_connections ALTER COLUMN id SET DEFAULT nextval('public.layanan_service_connections_id_seq'::regclass);
...
INSERT INTO public.cmdb_groups (id, name, description, color, "position", created_at, workspace_id) VALUES (74, 'TG1', '', '#e0e7ff', '{"x": -1194.0479292676446, "y": -1639.445158283596}', '2026-03-16 14:07:42.244738', 28) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (399, 'TGI2', 'server', '', '{"x": 159.87210783496738, "y": -817.4361367431829}', 'active', '', 'internal', '', 74, 0, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (400, 'TGI3', 'server', '', '{"x": 59.22141385184452, "y": -693.6083650573937}', 'active', '', 'internal', '', 74, 2, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (404, 'WSTI0', 'server', '', '{"x": -41.85453909171808, "y": -926.0911142875269}', 'active', '', 'internal', '', 74, 3, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (402, 'TGI5', 'server', '', '{"x": -228.50345678292712, "y": -1903.1224981711764}', 'active', '', 'internal', '', NULL, NULL, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (462, 'TPSAPP05', 'server', '', '{"x": 878.5073818190533, "y": -3831.5526550789036}', 'active', '', 'internal', '', NULL, 0, 'fisik', 30, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (464, 'TPSVDEV01', 'server', '', '{"x": 1252.53732973572, "y": -3834.0526550789036}', 'active', '', 'internal', '', NULL, 0, 'fisik', 30, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (465, 'TPSAPP02', 'server', '', '{"x": 1448.3706630690533, "y": -3833.21932174557}', 'active', '', 'internal', '', NULL, 0, 'fisik', 30, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (463, 'TPSWEB102', 'server', '', '{"x": 1066.7039964023863, "y": -3833.2625941335536}', 'active', '', 'internal', '', NULL, 0, 'fisik', 30, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (403, 'SS', 'server', '', '{"x": -541.914654657957, "y": -1940.0657934215653}', 'active', '', 'internal', '', NULL, NULL, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (401, 'TGI4', 'server', '', '{"x": -235.08213037076115, "y": -1660.3845614709687}', 'active', '', 'internal', '', NULL, NULL, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction) VALUES (253, 211, 212, '2026-03-05 18:46:56.01877', NULL, NULL, 10, 'backed_up_by', 'forward') ON CONFLICT DO NOTHING;
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction) VALUES (259, 211, 214, '2026-03-05 19:11:18.481293', NULL, NULL, 10, 'consumed_by', 'backward') ON CONFLICT DO NOTHING;
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction) VALUES (264, 214, 213, '2026-03-05 19:58:59.099359', NULL, NULL, 10, 'connects_to', 'bidirectional') ON CONFLICT DO NOTHING;
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction) VALUES (275, 393, 397, '2026-03-13 19:59:30.59081', NULL, NULL, 27, 'depends_on', 'forward') ON CONFLICT DO NOTHING;
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction) VALUES (276, 394, 395, '2026-03-13 20:00:17.77842', NULL, NULL, 27, 'depends_on', 'forward') ON CONFLICT DO NOTHING;
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction) VALUES (278, 392, 393, '2026-03-13 21:29:41.926588', NULL, NULL, 27, 'consumed_by', 'backward') ON CONFLICT DO NOTHING;
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction) VALUES (281, 342, 335, '2026-03-14 04:28:58.026974', NULL, NULL, 5, 'consumed_by', 'backward') ON CONFLICT DO NOTHING;
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction) VALUES (277, 395, 397, '2026-03-13 20:00:22.240481', NULL, NULL, 27, 'depends_on', 'forward') ON CONFLICT DO NOTHING;
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction) VALUES (291, 403, NULL, '2026-04-22 16:58:27.670958', 74, NULL, 28, 'depends_on', 'forward') ON CONFLICT DO NOTHING;
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction) VALUES (292, 403, 402, '2026-04-22 16:58:37.218429', NULL, NULL, 28, 'depends_on', 'forward') ON CONFLICT DO NOTHING;
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction) VALUES (293, 403, 401, '2026-04-22 16:58:51.045431', NULL, NULL, 28, 'depends_on', 'forward') ON CONFLICT DO NOTHING;
...
INSERT INTO public.cross_service_connections (id, source_service_item_id, target_service_item_id, workspace_id, connection_type, direction, created_at, updated_at) VALUES (3, 56, 53, 5, 'consumed_by', 'forward', '2026-03-13 22:33:03.827636', '2026-03-13 22:33:13.67433') ON CONFLICT DO NOTHING;
INSERT INTO public.cross_service_connections (id, source_service_item_id, target_service_item_id, workspace_id, connection_type, direction, created_at, updated_at) VALUES (14, 33, 44, 27, 'consumed_by', 'forward', '2026-03-17 14:42:27.394263', '2026-03-17 14:42:27.394263') ON CONFLICT DO NOTHING;
INSERT INTO public.cross_service_connections (id, source_service_item_id, target_service_item_id, workspace_id, connection_type, direction, created_at, updated_at) VALUES (16, 67, 61, 28, 'depends_on', 'forward', '2026-03-25 08:39:35.259872', '2026-03-25 11:07:44.922637') ON CONFLICT DO NOTHING;
INSERT INTO public.cross_service_connections (id, source_service_item_id, target_service_item_id, workspace_id, connection_type, direction, created_at, updated_at) VALUES (17, 58, 61, 28, 'consumed_by', 'forward', '2026-03-25 11:07:04.323407', '2026-03-25 11:08:00.9532') ON CONFLICT DO NOTHING;
INSERT INTO public.cross_service_connections (id, source_service_item_id, target_service_item_id, workspace_id, connection_type, direction, created_at, updated_at) VALUES (19, 80, 77, 27, 'connects_to', 'forward', '2026-04-01 09:33:26.562847', '2026-04-01 09:33:26.562847') ON CONFLICT DO NOTHING;
INSERT INTO public.cross_service_connections (id, source_service_item_id, target_service_item_id, workspace_id, connection_type, direction, created_at, updated_at) VALUES (20, 82, 76, 27, 'consumed_by', 'forward', '2026-04-01 09:45:13.675288', '2026-04-01 09:45:13.675288') ON CONFLICT DO NOTHING;
INSERT INTO public.cross_service_connections (id, source_service_item_id, target_service_item_id, workspace_id, connection_type, direction, created_at, updated_at) VALUES (21, 81, 78, 27, 'consumed_by', 'forward', '2026-04-01 09:45:34.557796', '2026-04-01 09:45:34.557796') ON CONFLICT DO NOTHING;
INSERT INTO public.cross_service_connections (id, source_service_item_id, target_service_item_id, workspace_id, connection_type, direction, created_at, updated_at) VALUES (22, 83, 79, 27, 'consumed_by', 'forward', '2026-04-01 09:46:03.284143', '2026-04-01 09:46:03.284143') ON CONFLICT DO NOTHING;
...
INSERT INTO public.edge_handles (id, edge_id, source_handle, target_handle, created_at, updated_at, workspace_id) VALUES (247, 'e403-401', 'source-bottom', 'target-left', '2026-04-22 16:58:56.924338', '2026-04-22 16:58:56.924338', 28) ON CONFLICT DO NOTHING;
...
INSERT INTO public.external_item_positions (id, workspace_id, service_id, external_service_item_id, "position", updated_at, created_at, is_auto_layouted, layout_hash) VALUES (43, 28, 41, 58, '{"x": 525.8296493887353, "y": -133.44144009349463}', '2026-03-25 08:40:38.582792', '2026-03-25 08:40:38.582792', false, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.external_item_positions (id, workspace_id, service_id, external_service_item_id, "position", updated_at, created_at, is_auto_layouted, layout_hash) VALUES (24, 28, 40, 61, '{"x": 50.04754354579245, "y": 163.73639215876108}', '2026-03-25 11:15:54.593358', '2026-03-17 09:18:56.544488', false, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.external_item_positions (id, workspace_id, service_id, external_service_item_id, "position", updated_at, created_at, is_auto_layouted, layout_hash) VALUES (42, 28, 41, 67, '{"x": -3.6235568578835, "y": -128.33604808679027}', '2026-04-21 14:53:50.608029', '2026-03-25 08:39:58.843612', false, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.layanan (id, name, description, status, "position", workspace_id, created_at, updated_at) VALUES (5, 'Layanan Test 1', NULL, 'active', '{"x": -343.63016946519457, "y": -2244.6230315262756}', 28, '2026-04-21 14:42:51.77607', '2026-04-21 14:43:49.765652') ON CONFLICT DO NOTHING;
INSERT INTO public.layanan (id, name, description, status, "position", workspace_id, created_at, updated_at) VALUES (3, 'gss.tps.co.id', NULL, 'active', '{"x": 463.8829773192771, "y": -4112.685039415556}', 27, '2026-04-21 10:24:01.575572', '2026-04-21 15:52:33.368872') ON CONFLICT DO NOTHING;
INSERT INTO public.layanan (id, name, description, status, "position", workspace_id, created_at, updated_at) VALUES (4, 'api.tps.co.id', NULL, 'active', '{"x": 863.4147689772391, "y": -4101.240310772024}', 27, '2026-04-21 10:45:40.626075', '2026-04-21 16:01:03.166541') ON CONFLICT DO NOTHING;
INSERT INTO public.layanan (id, name, description, status, "position", workspace_id, created_at, updated_at) VALUES (6, 'api.tps.co.id', NULL, 'active', '{"x": 937.5248123153929, "y": -4090.0786749701606}', 30, '2026-04-22 10:48:25.143101', '2026-04-22 10:56:09.835115') ON CONFLICT DO NOTHING;


--
-- Data for Name: layanan_connections; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: layanan_service_connections; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.service_connections (id, service_id, source_id, target_id, workspace_id, created_at, connection_type, propagation, updated_at) VALUES (11, 12, 17, 16, 5, '2026-02-18 11:33:45.799815', 'connects_to', 'source_to_target', '2026-03-13 22:00:34.513811') ON CONFLICT DO NOTHING;
INSERT INTO public.service_connections (id, service_id, source_id, target_id, workspace_id, created_at, connection_type, propagation, updated_at) VALUES (13, 19, 25, 19, 5, '2026-02-18 16:14:41.318574', 'connects_to', 'source_to_target', '2026-03-13 22:00:34.513811') ON CONFLICT DO NOTHING;
INSERT INTO public.service_connections (id, service_id, source_id, target_id, workspace_id, created_at, connection_type, propagation, updated_at) VALUES (14, 19, 23, 22, 5, '2026-02-19 08:48:01.118749', 'connects_to', 'source_to_target', '2026-03-13 22:00:34.513811') ON CONFLICT DO NOTHING;
INSERT INTO public.service_connections (id, service_id, source_id, target_id, workspace_id, created_at, connection_type, propagation, updated_at) VALUES (15, 19, 23, 21, 5, '2026-02-19 08:48:01.142032', 'connects_to', 'source_to_target', '2026-03-13 22:00:34.513811') ON CONFLICT DO NOTHING;
INSERT INTO public.service_connections (id, service_id, source_id, target_id, workspace_id, created_at, connection_type, propagation, updated_at) VALUES (16, 19, 23, 20, 5, '2026-02-19 08:48:01.222204', 'connects_to', 'source_to_target', '2026-03-13 22:00:34.513811') ON CONFLICT DO NOTHING;
INSERT INTO public.service_connections (id, service_id, source_id, target_id, workspace_id, created_at, connection_type, propagation, updated_at) VALUES (18, 38, 53, 54, 5, '2026-03-13 22:15:44.720912', 'connects_to', 'both', '2026-03-13 22:15:44.720912') ON CONFLICT DO NOTHING;
INSERT INTO public.service_connections (id, service_id, source_id, target_id, workspace_id, created_at, connection_type, propagation, updated_at) VALUES (19, 12, 18, 15, 5, '2026-03-14 04:26:44.206999', 'consumed_by', 'target_to_source', '2026-03-14 04:26:52.356618') ON CONFLICT DO NOTHING;
INSERT INTO public.service_connections (id, service_id, source_id, target_id, workspace_id, created_at, connection_type, propagation, updated_at) VALUES (24, 40, 58, 65, 28, '2026-03-25 11:09:32.911535', 'consumed_by', 'target_to_source', '2026-03-25 11:09:32.911535') ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_groups (id, service_id, name, description, color, "position", created_at, workspace_id) VALUES (10, 40, 'TG1', '', '#e0e7ff', '{"x": 263.0677754384408, "y": -232.9496132165142}', '2026-03-17 08:39:36.688007', 28) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (59, 40, 'TSGI3', 'server', '', '{"x": 355, "y": 55}', 'inactive', '', 'internal', '', 28, '2026-03-16 14:34:35.22843', '2026-03-17 13:59:48.164449', 10, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (60, 40, 'TSGI4', 'server', '', '{"x": 15, "y": 55}', 'inactive', '', 'internal', '', 28, '2026-03-16 14:34:41.22237', '2026-03-17 13:59:48.164449', 10, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (66, 40, '9', 'server', '', '{"x": 15, "y": 165}', 'inactive', '', 'internal', '', 28, '2026-03-17 13:55:47.062919', '2026-03-17 13:59:48.164449', 10, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (57, 40, 'TSGI1', 'server', '', '{"x": 15, "y": 55}', 'inactive', '', 'internal', '', 28, '2026-03-16 14:33:45.491337', '2026-03-17 14:45:40.867749', 10, 0, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (62, 40, '5', 'server', '', '{"x": 15, "y": 165}', 'inactive', '', 'internal', '', 28, '2026-03-17 13:55:33.367915', '2026-03-17 13:59:48.164449', 10, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (63, 40, '6', 'server', '', '{"x": 355, "y": 165}', 'inactive', '', 'internal', '', 28, '2026-03-17 13:55:36.935753', '2026-03-17 13:59:48.164449', 10, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (64, 40, '7', 'server', '', '{"x": 185, "y": 165}', 'inactive', '', 'internal', '', 28, '2026-03-17 13:55:40.435699', '2026-03-17 13:59:48.164449', 10, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (65, 40, '8', 'server', '', '{"x": 15, "y": 275}', 'inactive', '', 'internal', '', 28, '2026-03-17 13:55:44.04359', '2026-04-02 14:52:31.039621', 10, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (61, 41, 'SS1 Service', 'server', '', '{"x": 50.04754354579245, "y": 163.73639215876108}', 'active', '', 'external', '', 28, '2026-03-17 09:18:23.487013', '2026-04-21 14:52:23.568102', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (68, 41, 'SS1It', 'server', '', '{"x": 192.60726592940222, "y": 354.4797240403574}', 'active', '', 'internal', '', 28, '2026-03-17 14:03:18.95216', '2026-04-21 14:52:29.644785', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (84, 49, 'Permisson', 'server', '', '{"x": 110.9580844483482, "y": 116.58644470113214}', 'active', '', 'internal', '', 30, '2026-04-22 10:47:50.362594', '2026-04-22 10:47:50.362594', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (85, 47, 'Gateway', 'server', '', '{"x": 313.67037515628283, "y": 162.1380995352837}', 'active', '', 'internal', '', 30, '2026-04-22 10:48:06.585766', '2026-04-22 11:01:24.505504', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (67, 40, '10', 'server', '', '{"x": -247.69379012060392, "y": -23.03744338416155}', 'inactive', '', 'internal', '', 28, '2026-03-17 13:55:51.335482', '2026-04-22 16:59:36.102644', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (58, 40, 'TSGI2', 'web_application', '', '{"x": 422.8998886978436, "y": 249.00783151659385}', 'inactive', '', 'internal', '', 28, '2026-03-16 14:34:28.456735', '2026-04-22 16:59:36.102644', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_to_service_connections (id, cmdb_item_id, source_service_id, target_service_id, connection_type, direction, propagation, workspace_id, created_at, updated_at) VALUES (3, 403, 51, 40, 'connects_to', 'bidirectional', 'source_to_target', 28, '2026-04-22 16:51:18.912291', '2026-04-22 16:51:18.912291') ON CONFLICT DO NOTHING;
...
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (32, 393, 'NextJS', 'active', 'upload', '/uploads/cmdb-1773214356025-139971087.webp', NULL, NULL, '2026-03-11 14:32:35.674705', '2026-03-13 08:07:31.82411') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (34, 213, 'CTH', 'active', 'upload', '/uploads/cmdb-1773289369485-186664796.webp', NULL, NULL, '2026-03-12 11:16:14.635276', '2026-03-12 11:22:49.496388') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (39, 335, 'Oracle', 'active', 'preset', NULL, 'oracle', NULL, '2026-03-13 22:32:30.095009', '2026-03-13 22:32:30.095009') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (38, 342, 'Citrix', 'active', 'preset', NULL, 'postgresql', NULL, '2026-03-13 21:38:35.479154', '2026-03-14 04:31:20.236884') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (42, 450, 'ZZZ', 'active', 'preset', NULL, 'citrix', NULL, '2026-03-31 08:27:19.238601', '2026-03-31 08:27:19.238601') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (46, 397, 'Oracle', 'inactive', 'upload', '/uploads/cmdb-1776761795780-878503159.png', NULL, NULL, '2026-04-21 15:54:03.154065', '2026-04-21 15:56:35.795751') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (37, 395, '.NET', 'active', 'upload', '/uploads/cmdb-1773297652077-255781684.png', NULL, NULL, '2026-03-12 13:40:52.010662', '2026-04-21 15:59:57.681603') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (36, 395, 'NextJS', 'active', 'upload', '/uploads/cmdb-1773297614669-9992140.webp', NULL, NULL, '2026-03-12 13:40:14.610132', '2026-04-21 16:00:13.74037') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (43, 394, 'Backend', 'active', 'upload', '/uploads/cmdb-1775010255853-334693767.webp', NULL, NULL, '2026-04-01 09:24:15.618028', '2026-04-16 14:16:32.824793') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (44, 394, 'Frontend', 'active', 'upload', '/uploads/cmdb-1775010728863-414013957.webp', NULL, NULL, '2026-04-01 09:32:08.790834', '2026-04-16 14:17:33.462585') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (33, 393, '.NET', 'active', 'upload', '/uploads/cmdb-1773214861167-570179837.png', NULL, NULL, '2026-03-11 14:41:00.77037', '2026-04-16 14:19:11.834456') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (31, 392, 'PostgreSQL', 'active', 'upload', '/uploads/cmdb-1773211071627-590990177.webp', NULL, NULL, '2026-03-11 13:37:51.602131', '2026-04-16 14:19:15.026997') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (48, 463, 'Java', 'active', 'upload', '/uploads/cmdb-1776829561827-206502543.png', NULL, NULL, '2026-04-22 10:46:01.693836', '2026-04-22 10:46:01.840767') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (49, 464, 'NextJS', 'active', 'upload', '/uploads/cmdb-1776829607780-906794231.webp', NULL, NULL, '2026-04-22 10:46:47.737864', '2026-04-22 10:46:47.784611') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (50, 465, 'PostgreSQL', 'active', 'upload', '/uploads/cmdb-1776829648445-550631084.webp', NULL, NULL, '2026-04-22 10:47:28.312368', '2026-04-22 10:47:28.450076') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (47, 462, 'NextJS', 'active', 'upload', '/uploads/cmdb-1776829519480-540085703.webp', NULL, NULL, '2026-04-22 10:45:19.308828', '2026-04-22 11:01:01.893236') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (41, 403, 'SS1', 'active', 'preset', NULL, 'citrix', NULL, '2026-03-17 09:18:11.907902', '2026-04-22 13:39:25.739717') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (45, 403, 'SS2', 'active', 'preset', NULL, 'oracle', NULL, '2026-04-21 14:44:14.901164', '2026-04-22 13:39:25.771794') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (51, 403, 'SS3', 'active', 'preset', NULL, 'citrix', NULL, '2026-04-22 13:39:26.095089', '2026-04-22 16:59:30.875953') ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (40, 401, 'Citrix', 'inactive', 'preset', NULL, 'citrix', NULL, '2026-03-16 14:33:18.440082', '2026-04-22 16:59:36.09918') ON CONFLICT DO NOTHING;
...
INSERT INTO public.share_links (id, token, workspace_id, created_by, created_at, expires_at, is_active, access_count, password_hash, last_accessed_at, metadata) VALUES (17, 'EQYLZGDV', 10, 1889, '2026-02-27 10:43:30.995045', '2026-03-06 10:43:30.984', true, 4, NULL, '2026-03-05 20:11:04.679673', '{}') ON CONFLICT DO NOTHING;
INSERT INTO public.share_links (id, token, workspace_id, created_by, created_at, expires_at, is_active, access_count, password_hash, last_accessed_at, metadata) VALUES (21, '8N9S4746', 27, 1889, '2026-03-31 10:11:32.641258', '2026-03-31 11:11:32.638', true, 4, NULL, '2026-03-31 10:11:52.303988', '{}') ON CONFLICT DO NOTHING;
...
SELECT pg_catalog.setval('public.cmdb_items_id_seq', 465, true);
...
SELECT pg_catalog.setval('public.connections_id_seq', 293, true);
...
SELECT pg_catalog.setval('public.cross_service_connections_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.cross_service_edge_handles_id_seq', 61, true);
...
SELECT pg_catalog.setval('public.edge_handles_id_seq', 247, true);
...
SELECT pg_catalog.setval('public.external_item_positions_id_seq', 101, true);
...
--
-- Name: layanan_connections_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.layanan_connections_id_seq', 29, true);
...
SELECT pg_catalog.setval('public.layanan_id_seq', 6, true);


--
-- Name: layanan_service_connections_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.layanan_service_connections_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.service_connections_id_seq', 25, true);
...
SELECT pg_catalog.setval('public.service_edge_handles_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.service_items_id_seq', 85, true);
...
SELECT pg_catalog.setval('public.service_to_service_connections_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 51, true);
...
SELECT pg_catalog.setval('public.share_access_logs_id_seq', 139, true);
...
SELECT pg_catalog.setval('public.share_links_id_seq', 21, true);
...
SELECT pg_catalog.setval('public.workspaces_id_seq', 30, true);
...
--
-- Name: layanan_connections layanan_connections_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layanan_connections
    ADD CONSTRAINT layanan_connections_pkey PRIMARY KEY (id);
...
--
-- Name: layanan_service_connections layanan_service_connections_layanan_id_service_item_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layanan_service_connections
    ADD CONSTRAINT layanan_service_connections_layanan_id_service_item_id_key UNIQUE (layanan_id, service_item_id);


--
-- Name: layanan_service_connections layanan_service_connections_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layanan_service_connections
    ADD CONSTRAINT layanan_service_connections_pkey PRIMARY KEY (id);
...
--
-- Name: idx_layanan_conn_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_layanan_conn_source ON public.layanan_connections USING btree (source_type, source_id);


--
-- Name: idx_layanan_conn_target; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_layanan_conn_target ON public.layanan_connections USING btree (target_type, target_id);


--
-- Name: idx_layanan_conn_workspace; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_layanan_conn_workspace ON public.layanan_connections USING btree (workspace_id);


--
-- Name: idx_layanan_service_conn_layanan; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_layanan_service_conn_layanan ON public.layanan_service_connections USING btree (layanan_id);


--
-- Name: idx_layanan_service_conn_service; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_layanan_service_conn_service ON public.layanan_service_connections USING btree (service_id);


--
-- Name: idx_layanan_service_conn_service_item; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_layanan_service_conn_service_item ON public.layanan_service_connections USING btree (service_item_id);


--
-- Name: idx_layanan_service_conn_workspace; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_layanan_service_conn_workspace ON public.layanan_service_connections USING btree (workspace_id);


--
-- Name: idx_layanan_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_layanan_status ON public.layanan USING btree (status);


--
-- Name: idx_layanan_workspace; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_layanan_workspace ON public.layanan USING btree (workspace_id);
...
--
-- Name: layanan_service_connections update_layanan_service_conn_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_layanan_service_conn_updated_at BEFORE UPDATE ON public.layanan_service_connections FOR EACH ROW EXECUTE FUNCTION public.update_layanan_service_conn_updated_at();
...
--
-- Name: layanan_connections fk_layanan_conn_workspace; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layanan_connections
    ADD CONSTRAINT fk_layanan_conn_workspace FOREIGN KEY (workspace_id) REFERENCES public.workspaces(id) ON DELETE CASCADE;


--
-- Name: layanan_service_connections fk_layanan_service_layanan; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layanan_service_connections
    ADD CONSTRAINT fk_layanan_service_layanan FOREIGN KEY (layanan_id) REFERENCES public.layanan(id) ON DELETE CASCADE;


--
-- Name: layanan_service_connections fk_layanan_service_service; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layanan_service_connections
    ADD CONSTRAINT fk_layanan_service_service FOREIGN KEY (service_id) REFERENCES public.services(id) ON DELETE CASCADE;


--
-- Name: layanan_service_connections fk_layanan_service_service_item; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layanan_service_connections
    ADD CONSTRAINT fk_layanan_service_service_item FOREIGN KEY (service_item_id) REFERENCES public.service_items(id) ON DELETE CASCADE;


--
-- Name: layanan_service_connections fk_layanan_service_workspace; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layanan_service_connections
    ADD CONSTRAINT fk_layanan_service_workspace FOREIGN KEY (workspace_id) REFERENCES public.workspaces(id) ON DELETE CASCADE;


--
-- Name: layanan fk_layanan_workspace; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.layanan
    ADD CONSTRAINT fk_layanan_workspace FOREIGN KEY (workspace_id) REFERENCES public.workspaces(id) ON DELETE CASCADE;
