...
\restrict kQMYBSGJrjksEL2R63ncsguIudZpgVbkkjpHOVjCgrqh5GAyg6iTjnJnFJICvT0
...
\unrestrict kQMYBSGJrjksEL2R63ncsguIudZpgVbkkjpHOVjCgrqh5GAyg6iTjnJnFJICvT0
\connect cmdb_db
\restrict kQMYBSGJrjksEL2R63ncsguIudZpgVbkkjpHOVjCgrqh5GAyg6iTjnJnFJICvT0
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (471, 'api111', 'api_service', '', '{"x": -957.4666013797557, "y": -3544.766801928141}', 'active', '', 'internal', '', NULL, 0, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (467, 'WST01', 'server', '', '{"x": -654.6047895698678, "y": -3497.904076890128}', 'active', '', 'internal', '', NULL, 0, 'fisik', 28, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (464, 'TPSVDEV01', 'server', '', '{"x": 1370.916233408252, "y": -3816.636124132282}', 'active', '', 'internal', '', NULL, 0, 'fisik', 30, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (463, 'TPSWEB102', 'server', '', '{"x": 1072.1846510314053, "y": -3576.7284359235105}', 'active', '', 'internal', '', NULL, 0, 'fisik', 30, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.connections (id, source_id, target_id, created_at, target_group_id, source_group_id, workspace_id, connection_type, direction, target_service_id, target_service_item_id, source_service_id, source_service_item_id) VALUES (381, NULL, 471, '2026-05-03 10:08:14.637124', NULL, NULL, 28, 'consumed_by', 'backward', NULL, NULL, NULL, 94) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (91, 50, 'DB_GATEWAY', 'database', '', '{"x": 446.68783176356385, "y": -5.0566922328260375}', 'active', '', 'internal', '', 30, '2026-04-27 08:16:49.585207', '2026-05-03 12:23:47.525615', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (85, 47, 'Gateway', 'server', '', '{"x": 313.67037515628283, "y": 162.1380995352837}', 'active', '', 'internal', '', 30, '2026-04-22 10:48:06.585766', '2026-05-03 19:11:02.682464', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (84, 49, 'Permisson', 'server', '', '{"x": 110.9580844483482, "y": 116.58644470113214}', 'active', '', 'internal', '', 30, '2026-04-22 10:47:50.362594', '2026-05-03 19:11:09.143492', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at, workspace_id, "position", width, height, is_expanded) VALUES (47, 462, 'NextJS', 'active', 'upload', '/uploads/cmdb-1776829519480-540085703.webp', NULL, NULL, '2026-04-22 10:45:19.308828', '2026-05-03 19:11:03.62841', 30, '{"x": 0, "y": 0}', 120, 80, false) ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at, workspace_id, "position", width, height, is_expanded) VALUES (49, 464, 'NextJS', 'active', 'upload', '/uploads/cmdb-1776829607780-906794231.webp', NULL, NULL, '2026-04-22 10:46:47.737864', '2026-05-03 19:11:10.073769', 30, '{"x": 0, "y": 0}', 120, 80, false) ON CONFLICT DO NOTHING;
...
SELECT pg_catalog.setval('public.edge_handles_id_seq', 498, true);
