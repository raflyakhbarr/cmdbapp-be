...
\restrict lVj4Kbs7rGrZePOLY14PIN1SB9Uay00OZ6RAHvPBJWw7rO7OcBu50V8MUzFRyZ1
...
\unrestrict lVj4Kbs7rGrZePOLY14PIN1SB9Uay00OZ6RAHvPBJWw7rO7OcBu50V8MUzFRyZ1
\connect cmdb_db
\restrict lVj4Kbs7rGrZePOLY14PIN1SB9Uay00OZ6RAHvPBJWw7rO7OcBu50V8MUzFRyZ1
...
INSERT INTO public.external_item_positions (id, workspace_id, service_id, external_service_item_id, "position", updated_at, created_at) VALUES (8, 27, 32, 33, '{"x": -436.48967785348617, "y": 142.27532709131037}', '2026-03-13 19:56:38.388321', '2026-03-13 19:43:41.649738') ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (33, 31, 'Kantin Database', 'database', '', '{"x": -440.4896778534862, "y": 142.77532709131037}', 'inactive', '172.19.155.50', 'internal', '', 27, '2026-03-11 13:38:34.094558', '2026-03-13 21:31:45.754446', NULL, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
SELECT pg_catalog.setval('public.connections_id_seq', 278, true);
...
SELECT pg_catalog.setval('public.cross_service_connections_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.cross_service_edge_handles_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.edge_handles_id_seq', 217, true);
...
SELECT pg_catalog.setval('public.external_item_positions_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.service_items_id_seq', 52, true);
