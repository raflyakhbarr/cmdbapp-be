...
\restrict GYbCBOsEd1jytO8SZqyojltMLIKdOIV6pK93lJk2XmKXu5SruYkMRKuIE2pdmjE
...
\unrestrict GYbCBOsEd1jytO8SZqyojltMLIKdOIV6pK93lJk2XmKXu5SruYkMRKuIE2pdmjE
\connect cmdb_db
\restrict GYbCBOsEd1jytO8SZqyojltMLIKdOIV6pK93lJk2XmKXu5SruYkMRKuIE2pdmjE
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (469, 'api.tps.co.id/tjiwi', 'api_service', '', '{"x": 657.2791390736397, "y": -4164.045830932562}', 'active', '', 'internal', '', NULL, 0, 'virtual', 30, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.edge_handles (id, edge_id, source_handle, target_handle, created_at, updated_at, workspace_id) VALUES (331, 'cross-service-connection-29', 'source-left', 'target-bottom', '2026-04-29 09:23:51.141449', '2026-05-01 18:06:30.935837', 30) ON CONFLICT DO NOTHING;
...
INSERT INTO public.edge_handles (id, edge_id, source_handle, target_handle, created_at, updated_at, workspace_id) VALUES (415, 'layanan-edge-162', 'source-bottom', 'right-target', '2026-05-01 17:44:38.103697', '2026-05-01 17:44:38.103697', 30) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (84, 49, 'Permisson', 'server', '', '{"x": 110.9580844483482, "y": 116.58644470113214}', 'active', '', 'internal', '', 30, '2026-04-22 10:47:50.362594', '2026-05-01 21:27:49.691762', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (85, 47, 'Gateway', 'server', '', '{"x": 313.67037515628283, "y": 162.1380995352837}', 'active', '', 'internal', '', 30, '2026-04-22 10:48:06.585766', '2026-05-01 21:27:56.880658', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (92, 50, 'DB_PERMISSON', 'database', '', '{"x": 196.42704383409756, "y": -6.195245120935908}', 'active', '', 'internal', '', 30, '2026-04-27 08:18:56.971915', '2026-05-01 21:28:04.440895', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (91, 50, 'DB_GATEWAY', 'database', '', '{"x": 446.68783176356385, "y": -5.0566922328260375}', 'active', '', 'internal', '', 30, '2026-04-27 08:16:49.585207', '2026-05-01 21:28:07.615411', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
SELECT pg_catalog.setval('public.cmdb_items_id_seq', 469, true);
...
SELECT pg_catalog.setval('public.edge_handles_id_seq', 425, true);
