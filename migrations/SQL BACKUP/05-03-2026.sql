...
\restrict nrx50GLWuJ090SDMLAjAJe2a8kGYxwHkN70PryKsFq2oTBWN25rWKcVS5vxJvdG
...
\unrestrict nrx50GLWuJ090SDMLAjAJe2a8kGYxwHkN70PryKsFq2oTBWN25rWKcVS5vxJvdG
\connect cmdb_db
\restrict nrx50GLWuJ090SDMLAjAJe2a8kGYxwHkN70PryKsFq2oTBWN25rWKcVS5vxJvdG
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (214, 'WT2 Server2', 'server', '', '{"x": 938.8429774424958, "y": -231.31944573749945}', 'active', '', 'internal', '', NULL, 0, 'fisik', 10, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (211, 'WT2 DB1', 'database', '', '{"x": 1461.2952933348581, "y": -236.38924547302003}', 'active', '', 'internal', '', NULL, 0, 'fisik', 10, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (57, 'TPSBI', 'server', 'DASHBOARD BI', '{"x": -947.1380865663648, "y": -4396.459593738182}', 'active', '192.168.213.63', 'internal', '', NULL, NULL, 'fisik', 1, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (212, 'WT2 DB2', 'database', '', '{"x": 1984.1819531167152, "y": -342.03942452468425}', 'active', '', 'internal', '', NULL, 0, 'fisik', 10, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (100, 'DBTOS1', 'server', '', '{"x": 23.87526764309594, "y": -3921.5743104619087}', 'active', '192.168.195.138', 'internal', '', NULL, NULL, 'fisik', 1, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (335, 'WST1 01', 'server', '', '{"x": -888.2924247490752, "y": -1051.3261398063894}', 'active', '', 'internal', '', NULL, 0, 'fisik', 5, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (213, 'WT2 Server1', 'server', '', '{"x": 1333.8837078730337, "y": -561.9931713975814}', 'active', '', 'internal', '', NULL, 0, 'fisik', 10, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (342, 'Test 1', 'server', '', '{"x": -704.7099685608412, "y": -933.7409058860917}', 'active', '', 'internal', '', NULL, 0, 'fisik', 5, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (351, 'ELEKTRA', 'server', '', '{"x": 267.9597418736817, "y": -837.0161669123326}', 'active', '172.19.154.42', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'elektra.tps.co.id', 8111) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (348, 'CANTEEN', 'server', '', '{"x": 765.8555843314227, "y": -1025.7791715832982}', 'active', '172.19.155.51', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'canteen.tps.co.id', 83) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (353, 'PORTAL', 'server', '', '{"x": 769.5321834676577, "y": -837.8867174756288}', 'active', '172.19.155.51', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'portal.tps.co.id', 85) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (345, 'CLIQUE247', 'server', '', '{"x": 27.613868183826412, "y": -1021.7204057911039}', 'active', '172.19.162.34', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'clique247.tps.co.id', 82) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (356, 'STOCK', 'server', '', '{"x": 269.7837306938523, "y": -640.0265773012184}', 'active', '172.19.155.51', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'stock.tps.co.id', 8333) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (346, 'CLIQUE', 'server', '', '{"x": 273.377442136509, "y": -1021.0066373236851}', 'active', '172.19.162.34', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'clique.tps.co.id', 82) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (344, 'REMOTE', 'server', '', '{"x": -217.30968440689324, "y": -1018.7990439644739}', 'active', '172.19.220.24', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'remote.tps.co.id', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (357, 'XRAY', 'server', '', '{"x": 530.6474937332399, "y": -640.8971278645147}', 'active', '172.19.155.50', 'internal', '', NULL, 0, 'fisik', 26, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (352, 'GSS', 'server', '', '{"x": 527.3077883465587, "y": -837.8867174756288}', 'active', '172.19.155.51', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'gss.tps.co.id', 82) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (350, 'EDOC', 'server', '', '{"x": 22.44754138244872, "y": -826.1807663866779}', 'active', '172.19.155.51', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'edoc.tps.co.id', 7008) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (349, 'API', 'server', '', '{"x": -218.9682785294167, "y": -827.6964829531885}', 'active', '172.19.155.51', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'api.tps.co.id', 8484) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (347, 'AUTH', 'server', '', '{"x": 519.7292055140068, "y": -1021.8771878869813}', 'active', '172.19.155.51', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'auth.tps.co.id', 8484) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (355, 'ROOM', 'server', '', '{"x": 20.802375379234462, "y": -636.2411625794775}', 'active', '172.19.155.51', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'room.tps.co.id', 8589) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (354, 'QR', 'server', '', '{"x": -218.09772796612054, "y": -640.674579408815}', 'active', '172.19.155.51', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'qr.tps.co.id', 81) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (360, 'MYTPS', 'server', '', '{"x": 17.563497933363635, "y": -460.16347514626483}', 'active', '172.19.154.95', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'my.tps.co.id', 8333) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (361, 'VSS', 'server', '', '{"x": 265.23658099432123, "y": -464.0654588425818}', 'active', '172.19.154.42', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'vss.tps.co.id', 32005) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (358, 'ESS', 'server', '', '{"x": 764.0029740153581, "y": -643.2833949943213}', 'active', '172.19.154.99', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'ess.tps.co.id', 85) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (362, 'HSSE', 'server', '', '{"x": 530.0023277300255, "y": -465.8065599691739}', 'active', '172.19.154.41', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'hsse.tps.co.id	', 32009) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (364, 'ALESYS', 'server', '', '{"x": -222.3366054119913, "y": -255.17835736384865}', 'active', '172.19.154.42', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'alesys.tps.co.id', 8111) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (359, 'TPS', 'server', '', '{"x": -221.46605484869522, "y": -456.26149144994787}', 'active', '172.19.154.97', 'internal', '', NULL, 0, 'fisik', 26, NULL, 'tps.co.id', 3000) ON CONFLICT DO NOTHING;
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (363, 'SH', 'server', '', '{"x": 766.1287065474417, "y": -463.19282709898044}', 'active', '', 'internal', '', NULL, 0, 'fisik', 26, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group) VALUES (27, 24, '1', 'server', '', '{"x": 9.601042107211066, "y": 91.51961274031143}', 'active', '', 'internal', '', 10, '2026-03-04 14:25:59.931091', '2026-03-04 14:25:59.931091', NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.workspaces (id, name, description, is_default, created_at, updated_at) VALUES (26, 'TPS 1', '', true, '2026-03-05 11:31:23.768312', '2026-03-05 14:35:29.376032') ON CONFLICT DO NOTHING;
...
SELECT pg_catalog.setval('public.cmdb_items_id_seq', 364, true);
...
SELECT pg_catalog.setval('public.edge_handles_id_seq', 196, true);
...
SELECT pg_catalog.setval('public.service_items_id_seq', 27, true);
...
SELECT pg_catalog.setval('public.workspaces_id_seq', 26, true);
