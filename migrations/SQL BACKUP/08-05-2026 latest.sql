...
\restrict lMg6pFJShp9WfFKjvihsfnn4LGZwAonPKf5IWWTtBE2AwOotCcC6ilMgDZjtzpd
...
\unrestrict lMg6pFJShp9WfFKjvihsfnn4LGZwAonPKf5IWWTtBE2AwOotCcC6ilMgDZjtzpd
\connect cmdb_db
\restrict lMg6pFJShp9WfFKjvihsfnn4LGZwAonPKf5IWWTtBE2AwOotCcC6ilMgDZjtzpd
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (482, 'api.tps.co.di/tjiwi', 'web_application', '', '{"x": 572.4627575240974, "y": -4278.4958897823435}', 'active', '', 'internal', '', NULL, NULL, 'fisik', 30, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (463, 'TPSWEB102', 'server', '', '{"x": 921.7825895380067, "y": -3642.421169988839}', 'active', '', 'internal', '', NULL, 0, 'fisik', 30, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (84, 49, 'Permisson', 'server', '', '{"x": 110.95808444834825, "y": 152.5864447011321}', 'active', '', 'internal', '', 30, '2026-04-22 10:47:50.362594', '2026-05-08 10:23:29.017559', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (92, 50, 'DB_PERMISSON', 'database', '', '{"x": 187.332744435035, "y": -12.258111386977475}', 'active', '', 'internal', '', 30, '2026-04-27 08:18:56.971915', '2026-05-08 10:23:46.039948', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (91, 50, 'DB_GATEWAY', 'database', '', '{"x": 444.7421927885431, "y": -16.815406553395917}', 'active', '', 'internal', '', 30, '2026-04-27 08:16:49.585207', '2026-05-08 10:23:50.406538', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
SELECT pg_catalog.setval('public.cmdb_items_id_seq', 498, true);
...
SELECT pg_catalog.setval('public.cross_service_connections_id_seq', 47, true);
...
SELECT pg_catalog.setval('public.cross_service_edge_handles_id_seq', 101, true);
...
SELECT pg_catalog.setval('public.edge_handles_id_seq', 507, true);
...
SELECT pg_catalog.setval('public.external_item_positions_id_seq', 298, true);
...
SELECT pg_catalog.setval('public.service_items_id_seq', 122, true);
...
SELECT pg_catalog.setval('public.service_to_service_connections_id_seq', 45, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 79, true);
