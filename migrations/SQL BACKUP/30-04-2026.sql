...
\restrict 1VIQbWvhr0GFIIOrof99nX6momTrFkCaJVu8DHtvCcHPr3QTKgCkjTlgtkcKMCT
...
\unrestrict 1VIQbWvhr0GFIIOrof99nX6momTrFkCaJVu8DHtvCcHPr3QTKgCkjTlgtkcKMCT
\connect cmdb_db
\restrict 1VIQbWvhr0GFIIOrof99nX6momTrFkCaJVu8DHtvCcHPr3QTKgCkjTlgtkcKMCT
...
INSERT INTO public.edge_handles (id, edge_id, source_handle, target_handle, created_at, updated_at, workspace_id) VALUES (331, 'cross-service-connection-29', 'source-left', 'target-bottom', '2026-04-29 09:23:51.141449', '2026-04-30 10:12:58.508142', 30) ON CONFLICT DO NOTHING;
...
INSERT INTO public.layanan (id, name, description, status, "position", workspace_id, created_at, updated_at) VALUES (16, 'api.tps.co.id/api/tjiwi', NULL, 'active', '{"x": 646.4753442562782, "y": -3900.654958269949}', 30, '2026-04-27 08:30:34.83347', '2026-04-30 09:14:34.872087') ON CONFLICT DO NOTHING;
...
INSERT INTO public.layanan_connections (id, source_type, source_id, target_type, target_id, workspace_id, connection_type, created_at, updated_at, propagation_enabled, service_id) VALUES (150, 'service', 47, 'layanan', 16, 30, 'contains', '2026-04-28 14:16:13.46461', '2026-04-28 14:16:13.46461', true, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (84, 49, 'Permisson', 'server', '', '{"x": 110.9580844483482, "y": 116.58644470113214}', 'inactive', '', 'internal', '', 30, '2026-04-22 10:47:50.362594', '2026-04-30 10:59:44.791524', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (91, 50, 'DB_GATEWAY', 'database', '', '{"x": 446.68783176356385, "y": -5.0566922328260375}', 'inactive', '', 'internal', '', 30, '2026-04-27 08:16:49.585207', '2026-04-30 10:59:44.719763', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (92, 50, 'DB_PERMISSON', 'database', '', '{"x": 196.42704383409756, "y": -6.195245120935908}', 'inactive', '', 'internal', '', 30, '2026-04-27 08:18:56.971915', '2026-04-30 10:59:44.719763', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (85, 47, 'Gateway', 'server', '', '{"x": 313.67037515628283, "y": 162.1380995352837}', 'inactive', '', 'internal', '', 30, '2026-04-22 10:48:06.585766', '2026-04-30 10:59:44.779484', NULL, NULL, '', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at, workspace_id, "position", width, height, is_expanded) VALUES (47, 462, 'NextJS', 'inactive', 'upload', '/uploads/cmdb-1776829519480-540085703.webp', NULL, NULL, '2026-04-22 10:45:19.308828', '2026-04-30 10:59:44.780459', 30, '{"x": 0, "y": 0}', 120, 80, false) ON CONFLICT DO NOTHING;
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at, workspace_id, "position", width, height, is_expanded) VALUES (49, 464, 'NextJS', 'active', 'upload', '/uploads/cmdb-1776829607780-906794231.webp', NULL, NULL, '2026-04-22 10:46:47.737864', '2026-04-30 11:00:10.203539', 30, '{"x": 0, "y": 0}', 120, 80, false) ON CONFLICT DO NOTHING;
...
SELECT pg_catalog.setval('public.edge_handles_id_seq', 364, true);
...
SELECT pg_catalog.setval('public.layanan_connections_id_seq', 150, true);
