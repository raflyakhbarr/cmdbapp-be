...
\restrict pYhtZlwatFaMx78nwjiDAeLhGoneYGIPbrrff08F9Fqfg8EvtxaCzDevwFlD6cu
...
\unrestrict pYhtZlwatFaMx78nwjiDAeLhGoneYGIPbrrff08F9Fqfg8EvtxaCzDevwFlD6cu
\connect cmdb_db
\restrict pYhtZlwatFaMx78nwjiDAeLhGoneYGIPbrrff08F9Fqfg8EvtxaCzDevwFlD6cu
...
CREATE TABLE public.service_connections (
    ...
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT service_connections_propagation_check CHECK (((propagation)::text = ANY ((ARRAY['source_to_target'::character varying, 'target_to_source'::character varying, 'both'::character varying])::text[])))
);
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (131, 'Bank Server', 'server', '-', '{"x": 246.70744570998124, "y": -3224.1906285602504}', 'active', '192.168.146.212', 'eksternal', 'Gedung Baru', NULL, NULL, 'fisik', 1, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (57, 'TPSBI', 'server', 'DASHBOARD BI', '{"x": -965.4219728054034, "y": -4365.587669314633}', 'active', '192.168.213.63', 'internal', '', NULL, NULL, 'fisik', 1, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cmdb_items (id, name, type, description, "position", status, ip, category, location, group_id, order_in_group, env_type, workspace_id, storage, alias, port) VALUES (394, 'TPSDEV', 'server', '', '{"x": 673.8154047747767, "y": -3609.851698072634}', 'active', '172.19.154.95', 'internal', '', NULL, 0, 'fisik', 27, NULL, 'my.tps.co.id', 8333) ON CONFLICT DO NOTHING;
...
INSERT INTO public.cross_service_connections (id, source_service_item_id, target_service_item_id, workspace_id, connection_type, direction, created_at, updated_at) VALUES (2, 33, 44, 27, 'consumed_by', 'forward', '2026-03-13 19:43:12.693406', '2026-03-13 19:43:12.693406') ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (51, 36, 'Elektra', 'server', '', '{"x": 245.27898158082604, "y": 264.30434216616266}', 'active', '172.19.154.42', 'internal', '', 27, '2026-03-12 13:42:43.910871', '2026-03-12 13:42:54.174898', NULL, NULL, 'elektra.tps.co.id', 8111) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (32, 31, 'Elektra Database', 'database', '', '{"x": 11.250189434005733, "y": 12.553700449032874}', 'active', '172.19.155.50', 'internal', '', 27, '2026-03-11 13:38:24.655086', '2026-03-13 21:22:34.449059', NULL, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (35, 31, 'Gateway Database Dev', 'database', '', '{"x": -227.01856656010023, "y": 12.008285479064284}', 'active', '172.19.155.50', 'internal', '', 27, '2026-03-11 13:39:13.494432', '2026-03-13 19:47:39.673365', NULL, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (33, 31, 'Kantin Database', 'database', '', '{"x": -436.48967785348617, "y": 142.27532709131037}', 'active', '172.19.155.50', 'internal', '', 27, '2026-03-11 13:38:34.094558', '2026-03-14 04:47:05.854879', NULL, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (44, 32, 'Kantin', 'server', '', '{"x": 5.151097128431161, "y": 352.793190305936}', 'active', '172.19.155.51', 'internal', '', 27, '2026-03-12 08:27:48.961374', '2026-03-13 21:28:00.363741', NULL, NULL, 'canteen.tps.co.id', 83) ON CONFLICT DO NOTHING;
...
INSERT INTO public.service_items (id, service_id, name, type, description, "position", status, ip, category, location, workspace_id, created_at, updated_at, group_id, order_in_group, domain, port) VALUES (34, 31, 'Gateway Database', 'database', '', '{"x": -441.1569842608683, "y": 12.033374139293073}', 'active', '172.19.155.50', 'internal', '', 27, '2026-03-11 13:38:55.261448', '2026-03-13 19:47:37.276921', NULL, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO public.services (id, cmdb_item_id, name, status, icon_type, icon_path, icon_name, description, created_at, updated_at) VALUES (31, 392, 'PostgreSQL', 'active', 'upload', '/uploads/cmdb-1773211071627-590990177.webp', NULL, NULL, '2026-03-11 13:37:51.602131', '2026-03-13 21:30:56.223962') ON CONFLICT DO NOTHING;
...
SELECT pg_catalog.setval('public.cmdb_items_id_seq', 397, true);
...
SELECT pg_catalog.setval('public.connections_id_seq', 281, true);
...
SELECT pg_catalog.setval('public.cross_service_connections_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.cross_service_edge_handles_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.edge_handles_id_seq', 219, true);
...
SELECT pg_catalog.setval('public.external_item_positions_id_seq', 23, true);
...
SELECT pg_catalog.setval('public.service_connections_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.service_edge_handles_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.service_groups_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.service_items_id_seq', 56, true);
